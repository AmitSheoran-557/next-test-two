...
const Slider = () => {
  ...
  return (
    <div className="bg-hero-bg slider-section pt-[156px] lg:pb-[113px] md:pb-20 pb-12 overflow-hidden mx-auto flex justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-full max-w-[1140px] justify-between px-4 flex mx-auto">
          <Image className="lg:max-w-[58px] max-w-10 w-full" src="/assets/images/png/progress-bar-icon-1.png" alt="icon-1" width={58} height={58} />
          <Image className="lg:max-w-[58px] max-w-10 w-full" src="/assets/images/png/progress-bar-icon-2.png" alt="icon-2" width={58} height={58} />
          <Image className="lg:max-w-[58px] max-w-10 w-full" src="/assets/images/png/progress-bar-icon-3.png" alt="icon-3" width={58} height={58} />
          <Image className="lg:max-w-[58px] max-w-10 w-full" src="/assets/images/png/progress-bar-icon-4.png" alt="icon-4" width={58} height={58} />
        </div>
        <div className="bg-gray-200 w-full h-1 mt-2 absolute top-[430px] left-0">
